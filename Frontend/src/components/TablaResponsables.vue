<template>
  ...
  >
    ...
    <template v-slot:top>
      ...
      <v-toolbar flat color="light-green-lighten-5">
        <v-toolbar-title class="text-light-green-darken-4">
          <h4> 
    ...
    <template v-slot:no-data>
      <h3><b style="color: #33691E9c">¡Sin datos!</b></h3>
      <h3><b style="color: #33691E9c">¡Añada elementos a la tabla!</b></h3>
    </template>
  </v-data-table>
</template>
